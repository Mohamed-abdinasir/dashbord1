<header class="app-header"><a class="app-header__logo" href="index.php"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0IuGc8yKz4oNBr9R7OVAGWzDG7e23evWjqQ&usqp=CAU" widith= "90" height = "40" r><h4>school management system</h4></a>
      ...
      <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Show notifications"><i class="bi bi-bell fs-5"></i></a>
        <ul class="app-notification dropdown-menu dropdown-menu-right">
          ...
          <div class="app-notification__content">
            ...
            <li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><i class="bi bi-exclamation-triangle fs-4 text-warning"></i>
          </span>
                <div>
